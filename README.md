...
Documenta��o de setup e refer�ncia est� em `docs/` (local apenas, n�o versionada).
...
- 🔐 [SECURITY_POLICY.md](./SECURITY_POLICY.md) — Security guidelines and best practices
- 🔑 [CREDENTIALS_ROTATION.md](./CREDENTIALS_ROTATION.md) — How to rotate exposed credentials
...
- Rotate credentials if accidental exposure occurs — see [CREDENTIALS_ROTATION.md](./CREDENTIALS_ROTATION.md)
