  ...
  private initializePlans(): void {
    this.plans = [
      LandingPricingPlan.create(
        ...
        [
          "1 análise de pele gratuita",
          "Tipo de pele + condições detectadas",
          "Rotina de passos diários",
          "✗ Rotina com produtos personalizados",
      ...
      LandingPricingPlan.create(
        ...
        [
          "Análises de pele ilimitadas",
          "Rotina com produtos curados pela IA",
      ...
      LandingPricingPlan.create(
        ...
        [
          ...
          "Tipo de pele + condições detectadas",
          "Incrementa seu histórico de evolução",
          "Mantém sua rotina atual (passos ou premium)",
          "✗ Nova rotina com produtos personalizados",
        ],
        false,
        null,
        "Comprar Análise",
